...
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.eventpublisher.InMemoryEventPublisher;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.investor.cli.CliAdapter;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.investor.cli.CliCommandsMapper;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.investor.cli.CliSpringAdapterRunner;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.investor.cli.SurnameAwareCliCommandsMapper;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.investor.profile.InvestorProfileService;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.investor.profile.RestClientInvestorProfileService;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.investor.repository.InMemoryInvestorRepository;
...
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.rest.RestClient;
import pl.wojtyna.trainings.spring.examples.beans.crowdsorcery.rest.UnirestClient;
